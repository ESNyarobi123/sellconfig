    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(400px, 1fr)); gap: var(--spacing-xl);">
        ...
        <div class="admin-card">
            <div class="admin-card-header">
                ...
                <a href="{{ route('admin.sales') }}" class="btn btn-secondary btn-sm" wire:navigate>View All</a>
            </div>
        ...
        <div class="admin-card">
            <div class="admin-card-header">
                ...
                <a href="{{ route('admin.plans.index') }}" class="btn btn-secondary btn-sm" wire:navigate>Manage</a>
            </div>
            <div class="admin-card-body" style="padding: 0;">
                <div class="table-container">
                    <table class="table">
    ...
    <div class="admin-card">
        ...
        <div class="admin-card-body">
            <div class="action-buttons">
                <a href="{{ route('admin.plans.create') }}" class="btn btn-primary" style="width: auto;" wire:navigate>
                    ➕ Add New Plan
                </a>
                <a href="{{ route('admin.configs.create') }}" class="btn btn-secondary" style="width: auto;" wire:navigate>
                    📤 Upload Configs
                </a>
                <a href="{{ route('admin.settings') }}" class="btn btn-secondary" style="width: auto;" wire:navigate>
                    ⚙️ Settings
                </a>
            </div>
        </div>
