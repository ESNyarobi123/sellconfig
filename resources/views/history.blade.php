...
@section('title', 'Historia ya Manunuzi')
    ...
    <div class="card">
        ...
        @if($orders->isEmpty())
            <div class="empty-state">
                ...
                <a href="{{ route('home') }}" class="btn btn-primary" style="width: auto;">
                    <span>🏠</span>
                    Angalia Plans
                </a>
            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($order->order_status === 'delivered')
                                        <a href="{{ route('order.show', $order) }}" class="btn btn-secondary btn-sm">
                                            👁️ Angalia
                                        </a>
                                    @elseif($order->payment_status === 'processing')
                                        <a href="{{ route('order.waiting', $order) }}" class="btn btn-primary btn-sm">
                                            ⏳ Subiri
                                        </a>
                                    @else
